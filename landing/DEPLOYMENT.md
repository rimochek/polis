...
Live browser verification passed: landing and image load, CTA navigation, direct demo refresh, PDF page link, served PDF, review gate, HTML export, mobile insurer selection and no page overflow. No page errors were recorded in that scenario. Script: `scripts/landing-live-check.cjs`.
